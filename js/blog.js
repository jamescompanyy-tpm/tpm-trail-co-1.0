...
// POSTS DATA â€” Edit this array to manage your blog content
// To add a new post: copy one object, change the values, save the file.
// To remove a post: delete the object from the array.
// Fields: id, title, category, date, readTime, excerpt, tags, gradient, body
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
const POSTS = [
  {
    id: 1,
    ...
    body: `
      <p>Most hikers who lace up their boots at the Blue Hills Reservation trailhead are thinking about the summit. The view from Great Blue Hill at 635 feet is, rightfully, the draw â€” on a clear day you can see all the way to the Atlantic. But the ground you walk on carries a story far older than any trail map.</p>

      <h3>The Massachusett People</h3>
      <p>The Blue Hills were home to the Massachusett people for thousands of years before European contact. The name "Massachusetts" itself derives from the Algonquian word Massachusett, meaning "at the great hill" â€” a direct reference to the Blue Hills. This was not a peripheral landmark. It was a center of their world.</p>
      <blockquote>"The land remembers what the maps forget."</blockquote>
      <p>The Massachusett used the hills for hunting, ceremony, and as a geographic anchor for navigation across the coastal plain. The summit of Great Blue Hill was a place of orientation â€” from it, you could see the harbor, the marshes, the inland forests. It was, in the truest sense, a place where the people knew where they were.</p>

      <h3>What Changed</h3>
      <p>European settlement in the 1620s and 1630s brought rapid displacement. By the time the reservation was formally established in 1893, the Massachusett had been systematically removed from their ancestral territories through a combination of colonial land grants, violent conflict during King Philip's War (1675â€“1676), and forced assimilation policies.</p>
      <p>The trails we hike today often follow paths that were walked for millennia before they had names on a Massachusetts DCR map. The Skyline Trail. The Wolcott Path. The North Border Loop. Many of these routes trace old movement corridors through the hills â€” ways the land naturally wants to be traveled.</p>
      ...
      <ul>
        <li>Learn about the Massachusett Tribe at Ponkapoag â€” they maintain a presence at the reservation to this day</li>
  ...
  },
  {
    ...
    body: `
      ...
      <p>Trekking poles are wonderful but not necessary. A $400 technical pack is not needed for a day hike â€” a basic 20L daypack works perfectly. Gaiters are great for mud season but not essential otherwise. Expensive merino wool base layers are luxurious, but mid-tier synthetics work fine.</p>
      ...
      <p>If you're buying your first hiking boots: spend $80â€“$120, not $400. You need boots that fit, are broken in before the hike, and have a lugged rubber sole. That's it. You will figure out what features you actually want after a season of hiking. Don't let gear be the barrier to getting on the trail.</p>
  ...
  },
  {
    ...
    body: `
      ...
      <h3>The Treeline</h3>
      <p>Monadnock's treeline breaks at around 2,500 feet â€” unusually low for its elevation. This is the result of massive forest fires in the early 1800s, deliberately set by settlers trying to eliminate wolf habitat. The fires burned so hot they destroyed the soil layer, and the summit zone has never fully recovered. What looks like natural alpine terrain is, in part, a 200-year-old ecological wound.</p>

      <blockquote>"The mountain holds the memory of fire. You can feel it in the exposed rock."</blockquote>

      <h3>The Summit</h3>
      <p>We reached the summit at 6:22am. The sky to the east was already transitioning â€” deep indigo giving way to bands of amber and rose. We sat on the summit rocks in complete silence and watched the sun lift above the horizon over southern New Hampshire.</p>
  ...
  },
  {
    ...
    body: `
      ...
      <p>Much of New England's bedrock is schist â€” a metamorphic rock formed when ancient ocean sediments were subjected to enormous heat and pressure as continental plates collided roughly 400â€“500 million years ago. The shiny, flaky texture you see on exposed summit rocks is mica, one of schist's primary minerals. Those flecks of silver catch the light on granite ridges across Vermont, New Hampshire, and Massachusetts.</p>

      <h3>What the Glacier Left Behind</h3>
      <p>The last glacial maximum ended roughly 18,000 years ago. The Laurentide Ice Sheet â€” up to two miles thick in places â€” covered all of New England. As it retreated, between 10,000 and 15,000 years ago, it left behind a landscape that was essentially brand new. The U-shaped valleys, the rounded summits (called "whalebacks"), the scattered boulders sitting in impossible positions â€” all glacier.</p>
  ...
  },
  {
    ...
    readTime: "8 min read",
    author: "James Rivera",
    excerpt: "You don't need to spend $2,000 to sleep in the backcountry. Here's the honest, prioritized gear list I give every first-time backpacker â€” with budget notes on every item.",
    tags: ["Gear", "Backpacking", "Budget"],
    gradient: "linear-gradient(135deg, #6b4c35 0%, #c4956a 60%, #e8d5b7 100%)",
    body: `
      <p>The gear industry wants you to believe backpacking requires a $600 tent, a $400 sleep system, and a $200 pack. It doesn't. Here's the honest kit â€” prioritized by what actually matters for a 2â€“3 night trip in New England's backcountry.</p>

      <h3>The Big Three (Shelter, Sleep, Pack)</h3>
      <p>These are where weight and cost concentrate. You don't need ultralight for your first trips â€” you need adequate.</p>
      <ul>
        <li><strong>Tent:</strong> A freestanding 2-person tent in the $120â€“$200 range handles New England conditions. REI Half Dome, Big Agnes Copper Spur HV2 on sale. Avoid anything under $80 â€” rain seams matter.</li>
        <li><strong>Sleep System:</strong> A sleeping bag rated to 20Â°F covers most New England three-season conditions. Pair with a foam or inflatable sleeping pad (the pad matters as much as the bag for warmth). Budget: $150â€“$250 total.</li>
        <li><strong>Pack:</strong> 50â€“65L for 2â€“3 nights. Osprey Atmos or Aether for fit and durability. Can be found for $150â€“$200 on sale. Fit matters more than brand.</li>
      </ul>

      <h3>The Kitchen</h3>
      <ul>
        <li>A canister stove and fuel ($35â€“$50). Jetboil or MSR PocketRocket.</li>
        <li>A 700mL titanium or aluminum pot.</li>
        <li>A long-handled spork. That's it.</li>
        <li>A water filter â€” Sawyer Squeeze ($35) is the best value in backpacking gear, full stop.</li>
      </ul>
      ...
      <p>Cotton anything. A hatchet (you don't need a fire every night). More than two pairs of socks (three is the max). Any electronic device you don't absolutely need. The camp chair (luxury item â€” earn it later).</p>

      <p>Total budget for an adequate first-time backpacking kit: $400â€“$650. Not $2,000. Get out there.</p>
    `
  }
];
...
function renderGrid(posts) {
  ...
  // featured = first post in filtered set when showing all, else first result
  ...
  grid.innerHTML = rest.map((p, i) => `
    <div class="post-card reveal" style="transition-delay:${i * 80}ms" onclick="openArticle(${p.id})">
      ...
      <div class="card-body">
        <span class="post-category ${getCatClass(p.category)}" style="margin-bottom:.6rem">${p.category}</span>
        <div class="post-title">${p.title}</div>
        <p class="post-excerpt">${p.excerpt}</p>
        <div class="card-footer">
          <span class="card-meta">${p.date} Â· ${p.readTime}</span>
  ...
  document.getElementById('filterCount').textContent = `${posts.length} post${posts.length !== 1 ? 's' : ''}`;
}
...
// close on escape
document.addEventListener('keydown', e => { if (e.key === 'Escape') closeArticleBtn(); });
...
const blogObs = new IntersectionObserver(entries => {
  entries.forEach(e => { if (e.isIntersecting) { e.target.classList.add('visible'); blogObs.unobserve(e.target); } });
}, { threshold: .1 });

// Blog initialises on first visit via showPage('blog') â€” not on page load

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// CMS POST FETCHER
// Fetches posts from Netlify Function (reads _posts/ from GitHub)
// and merges them with the hardcoded POSTS array.
// CMS posts appear first (newest first), hardcoded posts follow.
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
let ALL_POSTS = [...POSTS]; // start with hardcoded posts
let cmsLoaded = false;
...
async function loadCMSPosts() {
  ...
  try {
    ...
    if (Array.isArray(cmsPosts) && cmsPosts.length > 0) {
      // Merge: CMS posts first, then hardcoded sample posts
      ALL_POSTS = [...cmsPosts, ...POSTS];
      // If any CMS post is marked featured, unmark hardcoded featured
      if (cmsPosts.some(p => p.featured)) {
        ALL_POSTS = ALL_POSTS.map(p => p.source === 'cms' ? p : { ...p, featured: false });
      }
    }
  } catch (e) {
    // Function not available locally or no posts yet â€” use hardcoded posts
